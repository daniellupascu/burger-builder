...
DEMO: https://react-my-burger-78b1e.firebaseapp.com/
...
We recommend to put the test files (or `__tests__` folders) next to the code they are testing so that relative imports appear shorter. For example, 
